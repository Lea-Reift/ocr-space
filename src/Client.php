...
class Client
{
    ...
    public function __construct(string $apiKey, string $baseUrl = "https://api.ocr.space")
    {
        $this->apiKey = $apiKey;
    ...
    protected function sendRequest(string $path, string $method = 'post', array $params = []): array
    {
    ...
    public function get(): array 
    {
        ...
        return $this->sendRequest("/parse/image", params: $params);
    }
}
